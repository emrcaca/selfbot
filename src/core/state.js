...
// Config will be loaded asynchronously, but we need a placeholder for initialization
let config = {
    CH_IDS: [],
    enableConsoleLog: false
};

// Initialize config from configManager (will be set during app startup)
const initializeConfig = (loadedConfig) => {
    config = loadedConfig;
 ...
 * @property {number} CAPTCHA_WEBHOOK_DELETE - CAPTCHA webhook message deletion delay
 */
const DELAYS = {
